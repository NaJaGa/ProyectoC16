...
var greenGroup, blueGroup, pinkGroup;
...
function setup() {
  ...
  //crear arco para disparar flechas (hecho)
  ...
  bow.scale = 1;
   ...
   score = 0  
  redB= new Group();
  //Crear un grupo para greenBalloon (globo verde) (hecho)
 greenGroup = new Group();
 //Crear un grupo para blueBalloon (globo azul) (hecho)
 blueGroup = new Group();
 //Crear un grupo para pinkBalloon (globo rosa) (hecho)
 pinkGroup = new Group;
...
function draw() {
 ...
 if(gameState === PLAY){
  ...
  bow.y = World.mouseY
   ...
   //liberar la flecha al presionar la barra espaciadora(heho)
  if (keyDown("space")) {
    createArrow();
    
  }
  
  //crear enemigos continuos (hecho)
